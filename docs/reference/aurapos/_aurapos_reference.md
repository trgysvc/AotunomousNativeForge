...
**Versiyon:** 1.1 | **Tarih:** 14 Mart 2026 (güncelleme: 10 Mayıs 2026 — v1.1 yenilikleri dahil edildi)

## RESMİ DOKÜMANTASYON REFERANSLARI (Araştırmacı için)

> ANF Researcher bu URL'leri planlama öncesi tarar. Kod yazarken bu linklerdeki resmi API imzaları geçerlidir.

| Teknoloji | Resmi Dokümantasyon |
|---|---|
| Next.js 15 App Router | https://nextjs.org/docs |
| Fastify 4 | https://fastify.dev/docs/latest/ |
| ElectricSQL / PGlite | https://electric-sql.com/docs |
...
| mdns-js | https://github.com/mdns-js/node-mdns-js |
